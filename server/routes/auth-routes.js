...
const { generateAccessToken, generateRefreshToken, verifyRefreshToken, authenticate, optionalAuthenticate, generateToken } = require('../middleware/auth');
    ...
    asyncHandler(async (req, res) => {
      ...
      res.json({
        ...
        data: {
          ...
          accessToken,
          refreshToken,
          expiresIn: process.env.JWT_EXPIRES_IN || process.env.ACCESS_TOKEN_EXPIRES_IN || '15m',
